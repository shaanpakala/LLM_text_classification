...
The input for this classification task is the 768 features generated by taking the sum of each sample's hidden state representation. This ensures consistency of the input size (especially since text input will naturally be of different lengths).
